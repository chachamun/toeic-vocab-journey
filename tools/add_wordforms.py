...
IRREG = {  # 會用到的不規則動詞：原形 → (過去式, 過去分詞)
    ...
    'fit': ('fitted/fit', 'fitted/fit'), 'keep': ('kept', 'kept'), 'stand': ('stood', 'stood'), 'sweep': ('swept', 'swept'), 'withhold': ('withheld', 'withheld'), 'broadcast': ('broadcast', 'broadcast'),
}
...
DOUBLE = {'log', 'set', 'get', 'let', 'put', 'shut', 'wrap', 'propel', 'sit', 'stop', 'ban', 'submit', 'admit', 'excel', 'lag', 'scrub', 'control', 'drop', 'plan', 'regret', 'refer', 'occur', 'prefer', 'permit', 'spike', 'drag', 'grip', 'jog', 'win', 'begin', 'commit', 'run', 'unplug', 'shop', 'fit', 'transfer', 'recap', 'mop', 'eavesdrop'}
